...
function Content(props) {
    const { items = [], initial = 0, hideControl, renderFile: renderFile$1 = renderFile.default, onRotate, onChange, onClose, onZoom, } = props;
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("div", { ref: box, className: classNames__default("i-preview-content", {
                ...
                }, onMouseDown: handleMouseDown, onClick: (e) => e.stopPropagation(), children: content }), !hideControl && (jsxRuntime.jsxs("div", { className: classNames__default("i-preview-controls", {
