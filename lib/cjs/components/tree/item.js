...
function TreeList(props) {
    ...
    return (jsxRuntime.jsx("div", { className: classNames__default.default("i-tree", className, {
            "i-tree-round": round,
        }), style: style, children: contents }));
}
const Header = (props) => {
    const { as: Tag = "a", href, selected, children, ...restProps } = props;
    const className = classNames__default.default("i-tree-item-header", {
...
const TreeItem = (props) => {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames__default.default("i-tree-item", {
