...
function Checkbox(props) {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames("i-checkbox i-input-label", {
            [`i-checkbox-${status}`]: status !== "normal",
            "i-input-inline": labelInline,
        }, className), ...restProps, children: [label && (jsxRuntime.jsxs("span", { className: 'i-input-label-text', children: [required && jsxRuntime.jsx("span", { className: 'error', children: "*" }), label, message && jsxRuntime.jsx("p", { className: 'i-checkbox-message', children: message })] })), jsxRuntime.jsx("div", { className: classNames("i-checkbox-options", {
