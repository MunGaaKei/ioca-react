...
function CheckboxItem(props) {
    ...
    return (jsxRuntime.jsxs("label", { className: classNames__default.default("i-checkbox-item", {
            [`i-checkbox-${state.status}`]: state.status !== "normal",
            disabled,
        }, className), ...restProps, children: [jsxRuntime.jsx("input", { type: 'checkbox', name: name, className: classNames__default.default("i-checkbox-input", {
