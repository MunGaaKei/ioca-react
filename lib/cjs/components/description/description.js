...
const Description = (props) => {
    ...
    return (jsxRuntime.jsx("div", { className: classNames__default.default("i-description", className), style: {
            ...
            return (jsxRuntime.jsxs("div", { className: classNames__default.default("i-description-item", {
