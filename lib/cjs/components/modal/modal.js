...
function Modal(props) {
    ...
    if (!show)
        return null;
    return reactDom.createPortal(jsxRuntime.jsx("div", { className: classNames__default.default("i-modal-container", {
            "i-modal-backdrop": !hideBackdrop,
            "i-modal-customized": customized,
            "i-modal-active": active,
            fixed,
        }, className), style: style, onClick: handleBackdropClick, children: jsxRuntime.jsxs("div", { className: classNames__default.default("i-modal", {
                bounced,
                shadow: !hideShadow,
            }), style: {
                width,
                ...
                onClick?.(e);
            }, ...restProps, children: [customized && children, !customized && (jsxRuntime.jsx(DefaultContent, { title: title, hideCloseButton: hideCloseButton, footer: footer, okButtonProps: okButtonProps, cancelButtonProps: cancelButtonProps, children: children, footerLeft: footerLeft, onOk: onOk, onClose: handleHide }))] }) }), document.body);
}
