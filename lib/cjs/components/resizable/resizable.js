...
const Resizable = (props) => {
    ...
    return (jsxRuntime.jsxs("div", { ref: ref, className: classNames__default.default("i-resizable", className, {
            [`i-resizable-vertical`]: vertical,
                ...
                }, children: other }), jsxRuntime.jsx("div", { className: classNames__default.default("i-resizable-line", {
