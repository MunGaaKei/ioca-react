...
function Cell(props) {
    ...
    return (jsxRuntime.jsx("div", { className: classNames__default("i-datagrid-cell", {
        ...
        }), "data-col": id, style: style, onClick: (e) => onCellClick?.(data, column, row, col, e), onDoubleClick: (e) => onCellDoubleClick?.(data, column, row, col, e), children: render?.(data[id], data, col) ?? (jsxRuntime.jsx("div", { className: classNames__default("i-datagrid-cell-content", {
