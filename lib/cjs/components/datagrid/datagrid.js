...
const Datagrid = (props) => {
    ...
    return (jsxRuntime.jsxs("div", { style: { maxHeight: height, ...mergedStyle }, className: classNames("i-datagrid-container", className, {
            "i-datagrid-bordered": border,
            "i-datagrid-striped": striped,
        }), children: [jsxRuntime.jsxs("div", { ref: container, className: classNames("i-datagrid", {
