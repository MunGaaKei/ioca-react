...
function Header(props) {
    ...
    return (jsxRuntime.jsx("div", { className: 'i-datagrid-header i-datagrid-row', children: columns.map((column, col) => {
            ...
            return (jsxRuntime.jsxs("div", { "data-col": id, className: classNames("i-datagrid-cell", {
                    "i-datagrid-has-sorter": sorter$1,
                    "i-datagrid-cell-fixed": fixed,
                }), style: { ...style, insetBlockStart: 0 }, onClick: (e) => onHeaderClick?.(column, e), children: [renderHeader?.(column, col) ?? (jsxRuntime.jsx("div", { className: classNames("i-datagrid-cell-content", {
