...
const Tabs = ((props) => {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames("i-tabs", { flex: vertical, [`i-tabs-${type}`]: type !== "default" }, className), ...rest, children: [jsxRuntime.jsxs("div", { className: classNames("i-tab-navs-container", {
                    "i-tab-navs-vertical": vertical,
                }), children: [prepend, jsxRuntime.jsxs("div", { ref: navsRef, className: classNames("i-tab-navs", `justify-${navsJustify}`), children: [state.tabs.map((tab, i) => {
                                const { title, key = i, closable } = tab;
                                return (jsxRuntime.jsxs("a", { ref: (ref) => (navRefs.current[i] = ref), className: classNames("i-tab-nav", {
                    ...
                    return (show && (jsxRuntime.jsx("div", { className: classNames("i-tab-content", {
                            "i-tab-active": isActive,
