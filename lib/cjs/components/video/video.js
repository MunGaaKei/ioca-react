...
const Video = (props) => {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames__default.default("i-video", className), style: { height, width, ...style }, onClick: handlePlay, onDoubleClick: () => handleFullscreen(), onMouseMove: handleMouseMove, children: [jsxRuntime.jsx("video", { ref: videoRef, onCanPlay: handleReady, ...restProps, controls: useOriginControls }), showControls && (jsxRuntime.jsxs("div", { className: classNames__default.default("i-video-controls", {
