...
function Radio(props) {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames("i-radio i-input-label", {
            [`i-radio-${status}`]: status !== "normal",
            "i-input-inline": labelInline,
        }, className), children: [label && (jsxRuntime.jsxs("span", { className: 'i-input-label-text', children: [required && jsxRuntime.jsx("span", { className: 'error', children: "*" }), label, message && jsxRuntime.jsx("p", { className: 'i-radio-message', children: message })] })), jsxRuntime.jsx("div", { className: classNames("i-radio-options", {
