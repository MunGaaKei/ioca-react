...
const Upload = (props) => {
    ...
    const defBtnProps = react.useMemo(() => ({
        children: jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [icon$1, " \u4E0A\u4F20"] }),
        ...defaultButtonProps,
    }), [defaultButtonProps]);
    const trigger = react.useMemo(() => {
        ...
        switch (mode) {
            case "card":
                return (jsxRuntime.jsx(button.default, { className: "i-upload-card-btn color-5", square: true, flat: true, outline: true, disabled: disabled, children: icon$1 }));
            default:
    ...
    }, [mode, children, disabled, defBtnProps, icon$1]);
