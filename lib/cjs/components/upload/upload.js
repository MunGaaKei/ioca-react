...
const Upload = (props) => {
    ...
    return (jsxRuntime.jsx(container.default, { as: 'div', label: label, labelInline: labelInline, className: classNames("i-input-label-file", className), style: style, children: jsxRuntime.jsxs("div", { className: classNames("i-upload-inner", {
