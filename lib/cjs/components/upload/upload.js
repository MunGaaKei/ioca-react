...
const Upload = (props) => {
    ...
    const trigger = react.useMemo(() => {
        ...
        switch (mode) {
            ...
            default:
                return (jsxRuntime.jsx(button.default, { className: 'i-upload-btn', disabled: disabled, children: defaultText }));
        }
    }, [mode, children]);
    ...
    return (jsxRuntime.jsx(container.default, { as: 'div', label: label, labelInline: labelInline, className: classNames__default.default("i-input-label-file", className), style: style, children: jsxRuntime.jsxs("div", { className: classNames__default.default("i-upload-inner", {
