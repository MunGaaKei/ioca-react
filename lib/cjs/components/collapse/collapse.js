...
const Collapse = (props) => {
    ...
    return (jsxRuntime.jsx("div", { className: classNames__default.default("i-collapse", {
            ...
            const isActive = multiple
                ...
                : state.active === key;
            return (jsxRuntime.jsxs("div", { className: classNames__default.default("i-collapse-item", className, {
