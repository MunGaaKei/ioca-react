...
const Number = (props) => {
    ...
    return (jsxRuntime.jsx(container.default, { label: label, labelInline: labelInline, className: className, style: style, tip: message ?? tip, status: status, children: jsxRuntime.jsxs("div", { className: classNames__default.default("i-input-item", {
