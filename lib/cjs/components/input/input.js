...
const Input = ((props) => {
    ...
    const inputProps = {
        ...
        name,
        value: state.value,
        className: classNames__default.default("i-input", `i-input-${type}`),
    ...
    return (jsxRuntime.jsx(container.default, { label: label, labelInline: labelInline, className: className, style: style, tip: message ?? tip, status: status, required: required, children: jsxRuntime.jsxs("div", { className: classNames__default.default("i-input-item", {
