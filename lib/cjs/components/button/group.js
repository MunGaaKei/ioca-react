...
function Group(props) {
    ...
    return (jsxRuntime.jsx("div", { className: classNames__default.default(className, vertical ? "i-btn-group-vertical" : "i-btn-group-horizonal"), style: style, children: nodes }));
}
