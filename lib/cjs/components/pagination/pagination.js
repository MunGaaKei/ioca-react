...
const Pagination = (props) => {
    ...
    return (jsxRuntime.jsxs("div", { className: classNames__default("i-pagination", className), ...restProps, children: [prev && (jsxRuntime.jsx(page.default, { page: page$1 - 1 || 1, disabled: page$1 === 1, onChange: handlePageChange, children: prev })), start > 1 && (jsxRuntime.jsx(page.default, { page: 1, onChange: handlePageChange, children: renderPage(1) })), start > 2 && renderEllipsis(), loop.map((p) => {
                return (jsxRuntime.jsx(page.default, { page: p, active: p === page$1, onChange: handlePageChange, children: renderPage(p) }, p));
            }), end < totalPage - 1 && renderEllipsis(), end < totalPage && (jsxRuntime.jsx(page.default, { page: totalPage, onChange: handlePageChange, children: renderPage(totalPage) })), next && (jsxRuntime.jsx(page.default, { page: page$1 + 1, disabled: page$1 === totalPage, onChange: handlePageChange, children: next }))] }));
};
