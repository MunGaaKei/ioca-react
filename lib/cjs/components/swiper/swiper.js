...
const Swiper = ((props) => {
    ...
    return (jsxRuntime.jsxs("div", { style: style, className: classNames__default.default("i-swiper", {
            "i-swiper-vertical": vertical,
            "i-swiper-initialized": state.initialized,
        }, className), children: [jsxRuntime.jsxs("div", { className: 'i-swiper-track', style: trackStyle, onMouseOver: handleMouseOver, onMouseLeave: handleMouseLeave, children: [jsxRuntime.jsx("div", { ref: listRef, className: classNames__default.default("i-swiper-list", {
                        ...
                        }) }), arrow && (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [(loop || state.current !== 0) && (jsxRuntime.jsx("a", { className: 'i-swiper-arrow i-swiper-prev', onClick: swipePrev, children: prev })), (loop || state.current < size - display) && (jsxRuntime.jsx("a", { className: 'i-swiper-arrow i-swiper-next', onClick: swipeNext, children: next }))] }))] }), indicator && (jsxRuntime.jsx("div", { className: classNames__default.default("i-swiper-indicators", {
                    "i-swiper-indicators-fixed": fixedIndicator,
                }), children: indicatorsLoop.map((_, i) => {
                    return (jsxRuntime.jsx("a", { className: classNames__default.default("i-swiper-indicator", {
