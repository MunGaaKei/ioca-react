...
const Swiper = ((props) => {
    ...
    return (jsxRuntime.jsxs("div", { style: style, className: classNames("i-swiper", {
            "i-swiper-vertical": vertical,
            "i-swiper-initialized": state.initialized,
        }, className), children: [jsxRuntime.jsxs("div", { className: 'i-swiper-track', style: trackStyle, onMouseOver: handleMouseOver, onMouseLeave: handleMouseLeave, children: [jsxRuntime.jsx("div", { ref: listRef, className: classNames("i-swiper-list", {
