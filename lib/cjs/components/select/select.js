...
const Select = (props) => {
    ...
    return (jsxRuntime.jsxs("label", { className: classNames__default("i-input-label", className, {
            "i-input-inline": labelInline,
                    ...
                    }), onClick: () => setActive(true), children: [prepend, jsxRuntime.jsx("input", { ref: ref, type: 'hidden', value: state.value, ...restProps }), multiple ? (hasValue ? (jsxRuntime.jsx("div", { className: classNames__default("i-input i-select", {
