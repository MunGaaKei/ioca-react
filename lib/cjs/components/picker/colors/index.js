...
var ColorsPanel__default = /*#__PURE__*/_interopDefault(ColorsPanel);
...
function ColorPicker(props) {
    ...
    if (usePanel) {
        return jsxRuntime.jsx(ColorsPanel__default.default, { ...props });
    }
    return (jsxRuntime.jsx(popup.default, { trigger: 'click', touchable: true, position: 'bottom', ...popupProps, visible: state.visible, content: jsxRuntime.jsx(ColorsPanel__default.default, { value: state.syncValue, disabledAlpha: disabledAlpha, panelRender: (panel) => {
