    ...
    return (
        <>
            ...
            <List className="my-12">
                ...
                <Item label={<code className="code">.flex-column</code>}>flex-direction: column;</Item>
                ...
                <Item label={<code className="code">.justify-center</code>}>
                    ...
                    <Flex className="justify-center bordered" gap={1} style={{ width: 160 }}>
                ...
                <Item label={<code className="code">.justify-between</code>}>
                    ...
                    <Flex className="justify-between bordered" gap={1} style={{ width: 160 }}>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                    </Flex>
                ...
                <Item label={<code className="code">.justify-evenly</code>}>
                    ...
                    <Flex className="justify-evenly bordered" gap={1} style={{ width: 160 }}>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                    </Flex>
                ...
                <Item label={<code className="code">.justify-start</code>}>
                    ...
                    <Flex className="justify-start bordered" gap={1} style={{ width: 160 }}>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                    </Flex>
                ...
                <Item label={<code className="code">.justify-end</code>}>
                    ...
                    <Flex className="justify-end bordered" gap={1} style={{ width: 160 }}>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                        <div className="pd-8 bg-blue"></div>
                    </Flex>
                </Item>
                <Item label={<code className="code">.items-start</code>}>align-items: start;</Item>
                <Item label={<code className="code">.items-center</code>}>align-items: center;</Item>
                <Item label={<code className="code">.items-end</code>}>align-items: end;</Item>
                <Item label={<code className="code">.self-center</code>}>align-self: center;</Item>
                ...
                <Item label={<code className="code">.text-center</code>}>text-align: center;</Item>
                ...
                <Item label={<code className="code">.ellipsis</code>}>文字溢出显示省略号...</Item>
                <Item label={<code className="code">.overflow-auto</code>}>overflow: auto;</Item>
                <Item label={<code className="code">.overflow-hidden</code>}>overflow: hidden;</Item>
                ...
                <Item label={<code className="code">.hidden</code>}>display: none !important;</Item>
                ...
                <Item label={<code className="code">.hover-shadow</code>}>
                    <div className="px-10 round-0 hover-shadow">鼠标移入时显示阴影</div>
                </Item>
                <Item label={<code className="code">.bg-transparent</code>}>背景透明</Item>
                <Item label={<code className="code">.no-transition</code>}>transition: none;</Item>
                <Item label={<code className="code">.hover-opacity</code>}>
                    鼠标移入时
                    <span className="round-0 hover-opacity">透明度</span>变1
                </Item>
                <Item label={<code className="code">.hover-parent</code>} className="hover-parent">
                ...
                <Item label={<code className="code">.pd</code>}>padding: var(--padding)</Item>
            </List>
            <h3 className="mt-40">其它</h3>
            <p className="my-12">
                可以设置一些宽度和边距等，<code className="code">n</code> 可以为以下值：0, 1, 2, 4, 6, 8, 10, 12, 16, 20, 24, 32, 36, 40, 60, 80, 100, 120, 160, 200；margin类型的 n 可以多个 auto
            </p>
            <List>
            ...
            <p className="my-12">以及宽度和高度，</p> <code className="code">p</code> 可以为以下值：10, 20, 25, 30, 40, 50, 60, 70, 75, 80, 90, 100
            <List>
