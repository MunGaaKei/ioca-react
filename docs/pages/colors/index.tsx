...
export default function Page() {
    const colors = ["black", "white", "red", "blue", "green", "yellow", "pink", "purple", "orange", "aqua", "grey", "brown"];
    ...
    return (
        <>
            ...
            <p className="my-12">
                从 0 ～ 10，都有对应字体色类名<code className="code">.color-[i]</code>
                和背景色类名<code className="code">.bg-[i]</code>。
            </p>
            <Flex columns={11} style={{ textAlign: "center" }} gap={4}>
